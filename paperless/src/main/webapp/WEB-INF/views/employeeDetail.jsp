				...
				<table class="empInfoTable">
					<tr>
							...
							<td rowspan="7" style="width:400px">
								<img class="emp_img" alt="사원사진" src="/img/${requestScope.empDTO.emp_img}" style="width:270px; height: 330px;">
							</c:if>
							
							<c:if test="${requestScope.role == 'USER'}">
							<td rowspan="9" style="width:400px">
								<img class="emp_img" alt="사원사진" src="/img/${requestScope.employeeDTO.emp_img}" style="width:270px; height: 330px;">
							</c:if>
